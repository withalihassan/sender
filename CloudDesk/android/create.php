...
");
        ...
        <div class="col-md-4 mb-3">
            <label class="form-label">OS Subscription Link</label>
            <div class="input-group">
                <input type="text"
                    class="form-control"
                    readonly
                    value="https://signin.aws.amazon.com/oauth?redirect_uri=https%3A%2F%2Faws.amazon.com%2Fmarketplace%2Fprocurement%3FproductId%3Dprod-3gv5jamcnmk76%26redirectUrl%3Dhttps%25253A%25252F%25252Faws.amazon.com%25252Fmarketplace%25252Fpp%25252Fprodview-mh7awwoai4xye%26ref_%3Dbeagle%26isauthcode%3Dtrue&client_id=arn%3Aaws%3Aiam%3A%3A015428540659%3Auser%2Fawsmp-contessa&response_type=code&iam_user=true&backwards_compatible=true&account=<?php echo $_GET["parent_id"];?>&flowStarted=1">
            </div>
        </div>
    </div>
    <script>
    ...
    <script>
        ...
        function checkAccountStatus() {
            $.post("actions/check_account_status.php", {
                aws_access_key: awsAccessKey,
                aws_secret_key: awsSecretKey
            }, resp => $("#response").html(resp));
        }
        ...
        function addAdminUser() {
            ...
            $.post("actions/add_admin_user.php", {
                aws_access_key: awsAccessKey,
                aws_secret_key: awsSecretKey,
                ac_id: parent_id,
                user_id: 1200
        ...
        function checkMembership() {
            ...
            $.post("actions/check_membership.php", {
    ...
    <script>
        ...
        function scanInstances() {
            ...
            $.post("actions/scan_instances.php", {
                aws_access_key: awsAccessKey,
                aws_secret_key: awsSecretKey,
                region: region
            }, function(json) {
