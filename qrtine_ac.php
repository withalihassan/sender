...
<head>
    <meta charset="UTF-8">
    <title>Home - Special Panelss</title>
...
<body>
    <div class="container-fluid" style="padding: 1% 4% 4% 4%;">
        ...
        <div class="table-section mb-5">
            <h2>Qurantined Accounts List</h2>
            ...
            <table id="accountsTable1" class="display table table-bordered">
                ...
                <tbody>
                    ...
                    $stmt = $pdo->query("SELECT * FROM accounts WHERE status='active' AND ac_worth='Quarantined' AND  by_user='$session_id'  AND last_used IS NULL ORDER BY 1 DESC");
